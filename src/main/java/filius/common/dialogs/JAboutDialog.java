...
public class AboutDialog extends JDialog implements I18n {
    ...
    private void initialize() {
    	...
    	gui.mapKeyToAction(getJContentPane(), "ESCAPE", closeActionListener);
    }
    ...
    private JPanel getJContentPane() {
        if (jContentPane == null) {
            ...
            personen.setText("<html>" + "<b>" + messages.getString("infodialog_msg3") + "</b>"
                    ...
                    + "<b>" + messages.getString("infodialog_msg11") + "</b><p>Christian Eibl, Patrice Tr&eacute;ton, PyroPeter</p>" + "</html>");
