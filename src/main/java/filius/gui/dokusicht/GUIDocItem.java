...
public class GUIDocItem {
    ...
    private Color color; 
    private Font font;
    private JDocElement elem;

    public static GUIDocItem createDocItem(JDocElement elem) {
        GUIDocItem item = new GUIDocItem();
    ...
    public JDocElement asDocElement() {
        if (elem == null) {
            elem = new JDocElement(type == TEXT);
            elem.setText(text);
