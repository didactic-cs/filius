...
public class HostOS extends InternetNodeOS {

    /**
     * ob die Konfiguration der Netzwerkkarte mit DHCP erfolgt
     */
    private boolean useDHCPConfiguration;
    ...
    public synchronized void start() {
        ...
        if (getUseDHCPConfiguration()) {
            dhcpClient = new DHCPClient();
            dhcpClient.setSystemSoftware(this);
            dhcpClient.startThread();
        } else if (dhcpServer.isActive()) {
            dhcpServer.startThread();
        }
    }
    ...
    public void stop() {
        ...
        dhcpServer.stopThread();
        if (dhcpClient != null) {
            dhcpClient.stopThread();
        }
    }
    ...
    /** Ob die Konfiguration der Netzwerkkarte mit DHCP erfolgt */
    public boolean getUseDHCPConfiguration() {
        return useDHCPConfiguration;
    }

    /** Ob die Konfiguration der Netzwerkkarte mit DHCP erfolgt */
    public void setUseDHCPConfiguration(boolean useDHCP) {
        this.useDHCPConfiguration = useDHCP;
    }
}
