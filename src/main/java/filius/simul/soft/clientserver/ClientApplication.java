...
public abstract class ClientApplication extends Application {
    ...
    public boolean istVerbunden() {
        Main.debug.println("INVOKED (" + this.hashCode() + ", T" + this.getId() + ") " + getClass() + " (ClientApplication), istVerbunden()");
        if (socket != null) {
    ...
    public void stopThread() {
        Main.debug.println("INVOKED (" + this.hashCode() + ", T" + this.getId() + ") " + getClass() + " (ClientApplication), beenden()");
        super.stopThread();
