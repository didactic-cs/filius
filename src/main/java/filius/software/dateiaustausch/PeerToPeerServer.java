...
/**
 * In dieser Klasse wird der Server der Peer-to-Peer-Anwendung implementiert. D.
 * h., dass hier eingehende Anfragen aus dem Peer-to-Peer-Netzwerk empfangen und
 * verarbeitet werden. <br />
 * Zur Verarbeitung der Anfragen wird jeweils ein neuer Mitarbeiter in einem
 * eigenen Thread gestartet.
 */
public class PeerToPeerServer extends TCPServerAnwendung {

	/**
	 * die Instanz der Peer-to-Peer-Anwendung, fuer die eingehende Anfragen
	 * verarbeitet werden.
	 */
	private PeerToPeerAnwendung peerToPeerAnwendung;

	/**
	 * Konstruktor zur Initialisierung der Peer-to-Peer-Anwendung und setzen des
	 * Ports 6346, bei dem auf eingehende Anfragen gewartet wird. Außerdem wird
	 ...
	 * Verbindungsanfrage eingegangen ist. Hier wird ein Mitarbeiter in einem
	 * neuen Thread gestartet, der fuer die Verarbeitung der eingehenden Anfrage
	 * genutzt wird.
	 */
